...
NovaAccess Codex pairing is host-generated.

The pairing URI is generated on your Codex host. It is not sent to GalaxNet or any website. NovaAccess imports it locally and stores the token in iOS Keychain.
